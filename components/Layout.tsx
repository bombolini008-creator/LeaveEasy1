          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center space-x-8">
              <div className="flex flex-col select-none justify-center">
                <span className="text-xl font-black uppercase tracking-tighter text-blue-950 leading-none">Amadeus Egypt</span>
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600 leading-none mt-1">vacation leave</span>
              </div>
